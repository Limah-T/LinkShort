...
from .auth_views import SetPasswordViewSet, SignupViewSet, LoginUserViewSet, UpdateUserViewSet, ResetPasswordView, SetPasswordViewSet, DeactivateUserViewSet, verify_email_for_signup, verify_reset_password, verify_deactivate_account, verify_email_for_update
